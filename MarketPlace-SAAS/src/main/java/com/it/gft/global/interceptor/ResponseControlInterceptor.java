...
public class ResponseControlInterceptor implements ResponseBodyAdvice<Message> {
    ...
    public Message<?> beforeBodyWrite(Message body, MethodParameter returnType, MediaType selectedContentType, Class<? extends HttpMessageConverter<?>> selectedConverterType,
