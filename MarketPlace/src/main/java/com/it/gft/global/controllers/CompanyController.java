...
public class CompanyController {
    ...
    public Message<Company> retrieveCompanyById(@PathVariable Integer id) {
    ...
    public Message<Company> retrieveCompany(@RequestBody Company payload) {
    ...
    public Message<Company> retrieveCompanyEx(@RequestBody Company payload) {
	Message<Company> request = MessageBuilder.withPayload(payload).build();
    ...
    public Message<List<Company>> retrieveAllCompanies(@RequestBody StandardOrder payload) {
